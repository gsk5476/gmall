...
public class CategoryController {
    ...
    public ResponseVo<List<CategoryEntity>> queryCategorysByPid(@PathVariable("parentId") Long pid){
        List<CategoryEntity> categoryEntities= this.categoryService.queryCategorysByPid(pid);
