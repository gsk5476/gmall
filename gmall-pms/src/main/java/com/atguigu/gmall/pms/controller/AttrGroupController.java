...
public class AttrGroupController {
    ...
    public ResponseVo<List<AttrGroupEntity>> queryGroupWithAttrsByIdCid(@PathVariable("catId") Long cid){
        List<AttrGroupEntity> groupEntities = this.attrGroupService.queryGroupWithAttrsByIdCid(cid);
